...
logo= pygame.image.load("gallery/bird.png")
bg=pygame.image.load("gallery/background.png")
player = pygame.image.load("gallery/player.png")
downpipe = pygame.image.load("gallery/pipe.png")
